...
router.post('/cart', (req, res) => res.send('Route for got to checkout page'));router.post('/shop/item/:id/add', (req, res) => res.send('Route for add the current item to the shop cart'));
